...
st.title("Streamlit Demo Manifold AI learning Saraswat")
...
if state == 'Green':
    ...
    st.warning('Some what like this color')
elif state == 'Red':
    st.error('Do not like this color')
...
st.sidebar.text("Developed by Saraswat")